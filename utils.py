...
def write_2images(image_outputs, display_image_num, image_directory, postfix, imgtype):
    ...
    __write_images(image_outputs[0:n//2], display_image_num,
                   '%s/gen_a2b_%s.png' % (image_directory, postfix), imgtype)
    __write_images(image_outputs[n//2:n], display_image_num,
                   '%s/gen_b2a_%s.png' % (image_directory, postfix), imgtype)
...
def get_model_list(dirname, key, snapshot_save_iter, iter=-1):
    # numpt = int(iter / snapshot_save_iter)
    # numpt = int(iter / 1000)
    numpt = 0
    ...
    # ##spine
    # last_model_name = gen_models[395]
    ## CTMR
    # last_model_name = gen_models[98]
    ## MRCT
    # last_model_name = gen_models[61]
